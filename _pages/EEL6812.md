...
|-------|-------|----------------|--------------|--------------|-------------------|-------------------|-------------------|
| 1 |  Jan 12 | Introduction <br/> A brief history of deep learning| | [A Logical Calculus of the Ideas Immanent in Nervous Activity](https://www.cs.cmu.edu/~epxing/Class/10715/reading/McCulloch.and.Pitts.pdf) <br/>[Perceptron](https://www.ling.upenn.edu/courses/cogs501/Rosenblatt1958.pdf) <br/> [Parallel Distributed Processing](https://stanford.edu/~jlmcc/papers/PDP/Chapter1.pdf) <br/> [LeCun's seminal paper on CNN](https://galileo-unbound.blog/wp-content/uploads/2025/02/lecun.neco_.1989.1.4.541.pdf)| | | |
|  |  Jan 14 | Linear algebra basics <br/> Probability basics <br/> Machine learning basics | |[Scalar, vectors, arrays, tensors with Python](https://d2l.ai/chapter_preliminaries/ndarray.html) <br/> [Linear algebra fundamental with Python](https://d2l.ai/chapter_preliminaries/linear-algebra.html) <br/> [Probability fundamentals with Python](https://d2l.ai/chapter_preliminaries/probability.html) | | | |
