...
|  |  Jan 14 | Linear algebra basics <br/> Probability basics <br/> Machine learning basics |[Basics](https://ucf-my.sharepoint.com/:b:/g/personal/sh662014_ucf_edu/IQAdrYchtnuYTY31LX9aN6ZvAUZuvAhzocnjYUuymZZjxOE?e=vAPpa6) |[Scalar, vectors, arrays, tensors with Python](https://d2l.ai/chapter_preliminaries/ndarray.html) <br/> [Linear algebra fundamental with Python](https://d2l.ai/chapter_preliminaries/linear-algebra.html) <br/> [Probability fundamentals with Python](https://d2l.ai/chapter_preliminaries/probability.html) | | | |
